  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <motion.div
        ...
        className="flex flex-col rounded-3xl border border-alert-100 bg-gradient-to-br from-alert-50 via-alert-50 to-alert-100 p-4 text-left shadow-card"
      >
        <Link href="/produk" className="flex flex-col h-full group focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-alert-600 rounded-2xl">
          ...
          <p className="mt-2 text-3xl font-extrabold leading-none text-alert-700">
            {lowStockCount}
            <span className="ml-1 text-sm font-bold">item</span>
          </p>
      ...
      <motion.div
        ...
        className="flex flex-col rounded-3xl border border-brand-200 bg-gradient-to-br from-brand-50 via-brand-100 to-brand-200 p-4 text-left shadow-card"
      >
        <Link href="/pemilik/pesanan" className="flex flex-col h-full group focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-700 rounded-2xl">
          ...
          <p className="mt-2 text-3xl font-extrabold leading-none text-brand-700">{activeOrders}</p>
          <p className="mt-1 text-[11px] font-semibold text-brand-600">menunggu diproses</p>
